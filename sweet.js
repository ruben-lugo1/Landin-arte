...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // JavaScript adicional para el visor de imágenes en una ventana emergente con el botón "Cerrar"
  document.addEventListener("DOMContentLoaded", function () {
    const imagenesGaleria = document.querySelectorAll(".imagen-galeria");
    const enlacesVerEnGrande = document.querySelectorAll(".ver-en-grande");
        ...
        <html>
          <head>
            ...
            <style>
              ...
              .boton-cerrar:hover {
                background-color: #9500d8;
              }
            </style>
          </head>
          <body>
            <img src="${src}" alt="Imagen en grande">
            <a href="#" id="cerrar" class="boton-cerrar">Cerrar</a>
            <script>
